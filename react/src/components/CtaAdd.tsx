			...
			<div className="gradient-border">
				<div className="content">
					...
					<div className="addInfo">
						<Title tagName="h4">
							{ getStrings( 'create-wooCommerce-product' ) }
						</Title>
						<p>
							<span>
								{ getStrings(
									'install-stock-sync-for-wooCommerce'
								) }
							</span>{ ' ' }
							{ getStrings( 'and sync your store products' ) }
						</p>
						<a
							className="btn ctaBtn"
							href="https://wordpress.org/plugins/stock-sync-with-google-sheet-for-woocommerce/"
							target="_blank"
							rel="nofollow"
						>
